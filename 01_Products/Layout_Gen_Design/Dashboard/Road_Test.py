...
if True:  # Phase 06 — Sketch roads
    ...
    if sketch.get("blocks_only"):
        ...
        if show_rack_w_rack and sketch.get("rack_buffers"):
            ...
            legended_rack = set()
            case_style = {
                "case1_rack": ('#00b894', f'Case 1 rack buffer ({Core.Layout06.RACK_CASE1_OFFSET} m)'),
                "case2_rack": ('#8e44ad', f'Case 2 rack buffer ({Core.Layout06.RACK_CASE2_OFFSET} m)'),
            }
            ...
            rack_block_names = list(Core.Layout06.RACK_BLOCKS) if hasattr(Core.Layout06, "RACK_BLOCKS") else list(rack_buffers)
