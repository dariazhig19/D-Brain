...
from Core.Main import (
    ...
    _place_lpg, _place_warehouse, _has_any_overlap, _OVERLAP_GAP
)
...
for i in range(5):
    ...
    placed["Water"] = _place_anchor(sw, sl, "Water", "N", 0.2, 0)
    ...
    ww = _try_place_collision_aware(sw, sl, "WT/WWT", placed, lambda: _place_wt_wwt(sw, sl, placed["Water"][0], placed["Water"][1], placed["Water"][2], margin))
    if ww is None:
